...
const ProductDetails = () => {
    ...
    >
      ...
      {menuOpen === product.id && (
        <div className="absolute top-10 right-2 bg-white border border-gray-300 rounded-lg shadow-md w-36 z-10">
          <ul>
            <li
              className="ABeeZee px-2 py-2 cursor-pointer hover:bg-gray-100"
      ...
      <div className="flex items-center gap-2 mb-2">
        {product.discountedPrice ? (
          <>
            <span className="text-[10px] lg:text-[12px] sm:text-[8px]">
              ${product.discountedPrice}
            </span>
  ...
  return (
    <div className=" mx-[100px]">
      ...
      <h2 className="flex justify-center text-[48px] pt-[25px] w-full font-ABeeZee">
        You might also like
      </h2>
