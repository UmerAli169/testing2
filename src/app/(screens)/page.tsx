  ...
  return (
    <div className='flex justify-center flex-col items-center'>
      <div className='w-full'>
        <div className='bg-[#F2F0F1] min-h-[662px] px-4 sm:px-[40px] lg:px-[100px]'>
          <div className='grid lg:grid-cols-2 gap-8  items-start '>
            ...
            <div className='flex justify-center lg:justify-end overflow-hidden'>
              <img src='/fasion.jpg' alt='Fashion' className='w-[662px] h-[662px]   overflow-hidden object-cover object-top  rounded-lg' />
            </div>
          </div>
        </div>
      </div>
